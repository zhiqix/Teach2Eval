...
from function import format_conversation, generate_message, generate_responses, filter
...
def dialogue_teacher(process_id, data, gpu_ids, model_name, strategy, can_tell_answer, turn, batch_size = 128):
    ...
    #生成prompt_teacher
    prompt_teacher_list = [
        context.format_prompt(whole_question_wo_options = whole_question_wo_options_list[idx], conversation_teacher = conversation_teacher_list[idx], turn = turn)
